...
int main()
{
    system("color B");//4 is red, 9 is blue
    int i;
    char entpass[11];
    char realpass[11] = "iloveminty";

    printf("\n\n\n\tPlease enter the password: ");
    scanf("%s" ,entpass);
    if (strcmp(realpass,entpass)==0){
        system("cls");
        system("color A");
        ...
        system("color C");
        printf("\n\n\n\tPassword is Wrong.");
        printf("Press 1 to try again or Press 0 to exit.");
        Beep(250, 200);
        Beep(250,200);
        scanf("%d",&i2);
        if (i2==1){
